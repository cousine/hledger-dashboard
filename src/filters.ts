import type { BalanceEntry, TabFilterState } from './hledger/types';
...
export function applyCurrencyFilter(entries: BalanceEntry[], currencies: string[]): BalanceEntry[] {
...
export function buildHledgerAccountArgs(filter: TabFilterState, defaults: string[]): string[] {
