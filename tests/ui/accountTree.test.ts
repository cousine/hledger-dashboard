...
describe('selectAll', () => {
  const tree: TreeNode[] = [
    { name: 'assets', fullPath: 'assets', children: [
      { name: 'bank', fullPath: 'assets:bank', children: [
        { name: 'checking', fullPath: 'assets:bank:checking', children: [] },
      ]},
    ]},
  ];
...
describe('hasSelectedDescendant', () => {
  it('returns true when a child is selected', () => {
    const node: TreeNode = { name: 'bank', fullPath: 'assets:bank', children: [
      { name: 'checking', fullPath: 'assets:bank:checking', children: [] },
    ]};
